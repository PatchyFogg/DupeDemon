...
def build_gui():
    ...
    class App(_TkBase):
        ...
        def add_folder(self):
            ...
            # this app already accepts multi-folder drops, so open a big
            # Finder window at a sensible starting point and let the user
            # drag several folders onto the list at once.
            if self.folders:
            ...
            script = (
                ...
                "  set bounds of targetWindow to {100, 100, 1000, 800}\n"
                "end tell"
            )
