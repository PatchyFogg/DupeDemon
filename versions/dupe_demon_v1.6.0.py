...
def find_similar_images(files, prefs, progress=None, cancel_event=None, cache=None):
    ...
    if n <= PAIRWISE_LIMIT:
        ...
        # No seen-pair set (it can balloon to GBs on similar-heavy libraries);
        # re-testing a pair is a cheap xor, and the union-find check below
        # skips pairs that are already grouped.
